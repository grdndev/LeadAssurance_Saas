...
export default function LeadFormTemplate({ config }: { config: ProductConfig }) {
    const router = useRouter();
    const product = getProductById(config.productType);
                                    ...
                                    {config.fields.map((field) => (
                                        <div key={field.name} className="space-y-2">
                                            ...
                                            {field.type === "select" && field.options ? (
                                                ...
                                                <Select
                                                    onValueChange={(value) => handleInputChange(field.name, value === "true")}
                                                >
                                                    <SelectTrigger className="rounded-full">
                                                        <SelectValue placeholder="Sélectionner..." />
                                                    </SelectTrigger>
                            ...
                            <div className="p-4 bg-primary/10 rounded-2xl border border-primary/20 space-y-3">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <Label htmlFor="consent" className="text-xs cursor-pointer">
                                        ...
                                        {config.title}. Je comprends que mes données seront traitées conformément au RGPD.
                                    </Label>
                                </div>
                            </div>
