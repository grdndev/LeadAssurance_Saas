...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="px-4 pt-4">
      <div className="px-3 py-2 rounded-lg text-center text-xs font-semibold bg-primary/10 text-primary border border-primary/20">
    ...
    <Link
    href="/dashboard"
    className="flex items-center justify-center gap-2 w-full px-3 py-2 text-xs font-medium text-primary hover:text-primary/50 transition-colors border border-dashed border-primary/30 rounded-lg"
    >
    Espace Courtier
    </Link>
    </div>
